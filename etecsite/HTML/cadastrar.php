...
<head>
    ...
    <title><?php echo "Cadastro - ETEC"; ?></title>
</head>
<body>
    <header>
        <section class="logo">
    ...
    <div class="overlay-contato">
        <div class="caixa-contato">
            ...
            <form action="confirmacao.php" method="POST">
                <div class="campo">
                    <label><?php echo "Nome Completo"; ?></label>
                    <input type="text" name="nome" placeholder="<?php echo "Seu nome completo"; ?>" required>
                </div>
                <div class="campo">
                ...
                <div class="campo">
                    ...
                    <input type="password" name="senha" placeholder="<?php echo "Crie uma senha"; ?>" required>
                </div>
                <div class="centralizar-btn">
                    <button type="submit" class="btn-enviar" style="border: none; cursor: pointer;"><?php echo "Cadastrar"; ?></button>
                </div>
            </form>
        </div>
    </div>
