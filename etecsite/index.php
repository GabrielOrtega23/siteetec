...
<body>
    <header>
        ...
        <ul class="ul1">
            ...
            <li class="li-1"><strong><a class="a1" href="HTML/cursos.php"><?php echo "Cursos"; ?></a></strong></li>
              <li 
            ...
            <li class="li-1"><strong><a class="a1" href="HTML/contato.php"><?php echo "Contato"; ?></a></strong></li>
            <li class="li-1"><strong><a class="a1" href="HTML/sobre.php"><?php echo "Sobre"; ?></a></strong></li>
        </ul>
    </header>
    ...
    <div class="bloco-1">
        ...
        <button class="btn1"><a class="Entrar" href="HTML/entrar.php"><?php echo "Entrar"; ?></a></button>
        <button class="btn2"><a class="Cadastrar" href="HTML/cadastrar.php"><?php echo "Cadastrar"; ?></a></button>
    </div>
